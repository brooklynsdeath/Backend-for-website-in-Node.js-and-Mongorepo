...
df = interest.drop(['contact', 'country', 'city',
                          'username', '__v', 'password', 'email', 'lastname', 'firstname'], axis=1)
#b = df['_id'].tolist()
#df
...
def recommendations(title, cosine_sim = cosine_sim):
    ...
    #print(score_series.iloc[1:])
    # getting the indexes of the 10 most similar interest
    top_30_indexes = list(score_series.iloc[1:30].index)
